...
var resizePizzas = function(size) {
	...
	function changePizzaSizes(size) {
		...
		// changed querySelectorAll() with getEleemntsByClassName("randomPizzaContainer").
		// took randomPizzas out of for loop to minimize calls to DOM
...
function updatePositions() {
	...
	//from; https://discussions.udacity.com/t/what-are-the-best-was-to-improve-the-updatepositions-and-changepizzasizes-functions/3102/13
	...
	//https://discussions.udacity.com/t/optimizing-the-updatepositions-function/2834/16
	//
	//From  http://wilsonpage.co.uk/preventing-layout-thrashing/ requestAnimationFrame(function() {
	//   for (var i = 0; i < items.length; i++) {
	//     var phase = Math.sin((document.body.scrollTop / 1250) + (i % 5));
	//     items[i].style.left = items[i].basicLeft + 100 * phase + 'px';
	//   }
	...
	//     items[i].style.left = items[i].basicLeft + 100 * phase + 'px';
	//   }
	//From  http://wilsonpage.co.uk/preventing-layout-thrashing/
	// requestAnimationFrame(function(){
	//   document.querySelectorAll(".randomPizzaContainer")[i].style.width = newwidth;
	// });
	// User Timing API to the rescue a
	// gain. Seriously, it's worth learning.
...
document.addEventListener('DOMContentLoaded', function() {
	var cols = 8;
	var s = 256;
	//reduced i (pizzs) to 50, the number that fit on a full screen (1200X1400)
	for(var i = 0; i < 50; i++) {
